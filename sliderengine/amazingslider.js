 ...
 */
(function ($) {
  $.fn.asHTML5VideoControls = function (
    skinFolder,
    parentInst,
    videoElem,
    hideControls,
...
(function ($) {
  $.fn.ashtml5lightbox = function (options) {
      ...
      $.each([node, parentNode], function (index, nodeValue) {
        if (nodeValue && nodeValue.attr("class")) {
          ...
          $.each(classList, function (index, className) {
            if (
              className &&
              className.toLowerCase().indexOf("html5lightbox-" + attr + "-") ==
                0
            ) {
    ...
    inst.createMarkup = function () {
      ...
      styleCss +=
        ".html5-hide {display:none !important;} #slider-html5-lightbox .html5-text {" +
      ...
      styleCss +=
        ...
        "}";
      styleCss +=
        "#slider-html5-lightbox .html5-error {" + inst.options.errorcss + "}";
      if (
      ...
      if (inst.options.titlestyle == "right") {
        styleCss +=
          "#slider-html5-lightbox .html5-elem-wrap {width:" +
        ...
        styleCss +=
          "#slider-html5-lightbox .html5-elem-wrap {height:100%;} #slider-html5-lightbox .html5-elem-data-box {width:" +
        ...
        inst.resizeLightbox(sizeObj.w, sizeObj.h, true, function () {
          ...
          var titlecode =
            elem[ELEM_WEBLINKTEXT] && elem[ELEM_WEBLINKTEXT].length > 0
              ? " title='" + elem[ELEM_WEBLINKTEXT].replace(/'/g, "&#39;") + "'"
              : "";
          var targetcode =
    ...
    inst.calcElemSize = function (sizeObj, keepratio) {
      ...
      var w0 =
        winWidth - 2 * inst.options.bordersize - 2 * inst.options.bordermargin;
      if (
        inst.options.resizeleftright &&
        (inst.options.titlestyle == "left" ||
          inst.options.titlestyle == "right") &&
  ...
  $.fn.amazingslider = function (options) {
    ...
    AmazingSlider.prototype = {
        ...
        $(".amazingslider-slides", this.container)
          ...
          .each(function () {
            ...
            if (img.length > 0) {
              ...
              var title =
                img.attr("title") && img.attr("title").length > 0
                  ? img.attr("title")
                  : "";
              ...
              if (buttonObj.length > 0)
                if (buttonObj.parent().is("a"))
                  ...
                  button = buttonObj.clone().wrapAll("<div/>").parent().html();
              var video = [];
              var mediaType =
                lightbox && img.parent() && img.parent().data("mediatype")
                  ? img.parent().data("mediatype")
                  : instance.checkVideoType(link);
              if ($("video", $(this)).length > 0) {
                ...
                if (
                  !videoSrc &&
                  $video.data("src") &&
                  $video.data("src").length > 0
                )
                  videoSrc = $video.data("src");
                mediaType = $video.data("mediatype")
                  ? $video.data("mediatype")
                  : instance.checkVideoType(videoSrc);
              ...
              var $video = $("video", $(this));
              var videoSrc = $video.attr("src");
              var mediaType = $video.data("mediatype")
                ? $video.data("mediatype")
        ...
        if (this.lightboxArray.length > 0) {
          ...
          var lightboxOptions = {
            ...
            socialpositionsmallscreen:
              this.options.lightboxsocialpositionsmallscreen,
          ...
          if ($("#wpsliderlightbox_advanced_options").length)
            $.each(
              $("#wpsliderlightbox_advanced_options").data(),
              function (key, value) {
                lightboxOptions[key.toLowerCase()] = value;
              }
            );
          if (
            $("#wpsliderlightbox_advanced_options_" + this.options.sliderid)
              .length
          )
            $.each(
              $(
      ...
      createWm: function () {
        ...
        if (this.options.watermarklink) {
          html +=
            ...
            "'";
          if (
            this.options.versionmark == "AMC" + "om" ||
            (this.options.versionmark == "AML" + "ite" &&
              this.options.skin &&
              $.inArray(this.options.skin, ["classic", "cube", "content"]) >= 0)
          )
        ...
        if (this.options.watermarkstyle == "text")
          ...
          if (
            watermarkimage.substring(0, 7).toLowerCase() != "http://" &&
            watermarkimage.substring(0, 8).toLowerCase() != "https://"
          )
            watermarkimage = this.options.skinsfolder + watermarkimage;
          html +=
            "<img alt='' src='" + watermarkimage + "' style='border:none;' />";
        }
      ...
      showSocial: function () {
        ...
        var instance = this;
        var socialCode =
          '<div class="amazingslider-social-' +
          this.id +
          '" style="display:' +
          (this.options.socialmode == "mouseover" ? "none" : "block") +
          ";" +
          this.options.socialposition +
          '">';
        var socialBtnCSS =
          (this.options.socialdirection == "horizontal"
            ? "display:inline-block;"
            : "display:block;") + "margin:4px;";
        var socialCSS =
          "display:table-cell;width:" +
        ...
        if (this.options.socialmode == "mouseover")
          $(".amazingslider-wrapper-" + this.id, this.container).hover(
            function () {
              ...
              $(
                ".amazingslider-social-" + instance.id,
                instance.container
              ).fadeIn();
            },
            function () {
        ...
        $(".amazingslider-social-btn", this.container).click(function () {
          ...
          var shareMedia = instance.absoluteUrl(
      ...
      playVideo: function (autoplay) {
        ...
        if (
          autoplay &&
          this.options.playmutedandinlinewhenautoplay &&
        ...
        if (type == TYPE_VIDEO_YOUTUBE)
          this.playYoutubeVideo(href, autoplay, muted, playsinline);
        else if (type == TYPE_VIDEO_VIMEO)
          this.playVimeoVideo(href, autoplay, muted, playsinline);
      ...
      playMp4Video: function (href, webmhref, autoplay, muted, playsinline) {
        ...
        if (
          (ASPlatforms.isIE10() && this.options.forceflashonie10) ||
          (ASPlatforms.isIE11() && this.options.forceflashonie11)
        )
          isHTML5 = false;
      ...
      embedHTML5Video: function (
        ...
        if (
          ...
          ((ASPlatforms.isIE6789() ||
            ASPlatforms.isIE10() ||
            ASPlatforms.isIE11()) &&
            this.options.nativecontrolsonie) ||
        ...
        if (ASPlatforms.isIOS() || ASPlatforms.isAndroid())
          this.options.nativecontrolsonfullscreen = true;
        $container.html(
      ...
      playIframeVideo: function (href, autoplay) {
        ...
        if (this.options.previewmode) {
          $videoWrapper.html(
            "<div class='amazingslider-error-" +
              this.id +
              "'>To view the video, publish the slider then open it in your web browser</div>"
          );
          return;
        } else {
          var src = href;
      ...
      playYoutubeVideo: function (href, autoplay, muted, playsinline) {
        ...
        if (ASYouTubeIframeAPIReady) {
          ...
          if (instance.options.videohidecontrols)
            params = $.extend({}, params, { controls: 0, showinfo: 0 });
          ...
          new YT.Player("amazingslider-video-" + this.id, {
            ...
            events: {
              onVolumeChange: function (event) {
                if (!event.target.isMuted() && event.target.getVolume() > 0)
                  instance.videoAutoplayMode = false;
              },
      ...
      createText: function () {
        ...
        this.container.on(
          ...
          function (event, prev, cur) {
            ...
            var titleTag = instance.options.outputtext
              ? instance.options.titletag
              : "div";
            var descriptionTag = instance.options.outputtext
              ? instance.options.descriptiontag
              : "div";
            if (instance.textoptions.textstyle == "static") {
              ...
              switch (instance.textoptions.textpositionstatic) {
                ...
                case "left":
                  $textWrapper.css({
                    width:
                      instance.textoptions.textleftrightpercentforstatic + "%",
                    height: "100%",
                    position: "absolute",
                    left: "0px",
                    top: "0px",
            ...
            var $text = $(
              ".amazingslider-text-" + instance.id,
              instance.container
            );
            var $title = $(
            ...
            var $button = $(
              ".amazingslider-button-" + instance.id,
              instance.container
            );
            if (instance.textoptions.textstyle == "static") {
              ...
              if (instance.elemArray[cur][ELEM_BUTTON].length > 0)
                $button
                  .html(instance.elemArray[cur][ELEM_BUTTON])
                  .css({ display: "block" });
                ...
                $textWrapper.fadeOut(function () {
                  ...
                  if (
                    ...
                    if (effects2) {
                      ...
                      effect2 =
                        effects2[Math.floor(Math.random() * effects2.length)];
                    ...
                    switch (effect2) {
                      case "fade":
                        ...
                        $textBox2
                          .delay(instance.textoptions.texteffectdelay2)
                          .fadeTo(instance.textoptions.texteffectduration2, 1);
                        break;
                      case "slide":
                        var effect_dir2 =
                          instance.textoptions.texteffectslidedirection2;
      ...
      resizeFullscreenImage: function ($imgElem) {
        if (
          $imgElem.data("originalwidth") <= 0 ||
          $imgElem.data("originalheight") <= 0
        )
          return;
        var imgRatio =
          $imgElem.data("originalheight") / $imgElem.data("originalwidth");
        ...
        if (sliderRatio < imgRatio)
          ...
          this.curImageMarginLeft =
            (1 / sliderRatio - 1 / imgRatio) * sliderRatio * 50;
      ...
      resizeSlider: function () {
        if (!this.container.parent() || !this.container.parent().width())
          return;
        if (
          this.options.fullbrowserwidth &&
          this.options.usejsforfullbrowserwidth
        ) {
        ...
        if (
          ...
          this.options.forcewidthtoevenforslice
        )
        ...
        if (this.options.isfullscreen) {
          ...
          if (this.options.ratioresponsive) {
            var winWidth = this.options.isMobile
        ...
        this.container.css({
          ...
          height:
            ...
            this.options.navmultirows
              ? "auto"
              : this.options.height,
        });
        if (
          this.options.navstyle == "thumbnails" &&
          this.options.navthumbresponsive
        )
        ...
        if (this.options.navdirection == "vertical") {
          ...
          $bulletWrapper.css({ width: "100%", height: "auto" });
        else {
          var len =
            this.options.navstyle == "none"
              ? 0
        ...
        if (
          this.options.navmultirows &&
          this.options.navdirection == "horizontal" &&
          this.options.navthumbresponsivemode == "samecolumn"
        ) {
          ...
          for (var i = 1; i < $bullets.length; i++)
            if ((i + 1) % this.options.navthumbcolumn == 0)
              $bullets.eq(i).css({ "margin-right": 0 });
            else
              $bullets
                .eq(i)
                .css({ "margin-right": this.options.navspacing + "px" });
        }
        if (this.options.navthumbnavigationstyle != "auto") {
          if (this.options.navmultirows) {
            if (this.options.navdirection == "horizontal") {
              var n = Math.floor(
                $nav.width() / (this.options.navwidth + this.options.navspacing)
              );
              if (n <= 0) n = 1;
              m =
                Math.floor(
                  ($nav.width() -
                    n * this.options.navwidth -
                    (n - 1) * this.options.navspacing) /
                    2
                ) - 2;
            ...
            if (this.options.navdirection == "vertical") {
              ...
              if (this.options.navthumbnavigationstyle == "arrow") {
                m =
                  this.options.navthumbnavigationarrowimagewidth +
                  this.options.navspacing;
                if (this.options.navdirection == "horizontal") {
                  var n = Math.floor(
                    ($nav.width() - 2 * m + this.options.navspacing) /
            ...
            if (this.options.navdirection == "vertical")
              $bulletWrapper.css({ "margin-top": 0 });
          ...
          if (
            ...
            var p =
              this.options.navdirection == "vertical"
                ? this.options.navwidth / 2 -
                  this.options.navthumbnavigationarrowimagewidth / 2
                : this.options.navheight / 2 -
                  this.options.navthumbnavigationarrowimageheight / 2;
            if (
              this.options.navposition == "bottomleft" ||
              this.options.navposition == "bottomright" ||
              this.options.navposition == "bottom" ||
              this.options.navposition == "right"
            )
              p += bulletPos;
            if (this.options.navdirection == "vertical") {
              $carLeftArrow.css({
                top:
                  this.options.navthumbnavigationstyle == "arrowoutside"
                    ? "-" +
                      this.options.navthumbnavigationarrowimageheight +
                      "px"
                    : "0px",
                left: "0px",
                "margin-left": p + "px",
        ...
        if (
          ...
          this.options.navstyle != "none" &&
          $(
            "#amazingslider-bullet-" + this.id + "-" + this.curElem,
            this.container
          ).length > 0
        )
          this.adjustNav(
      ...
      createStyle: function () {
        ...
        this.options.navoriginalthumbtitleheight =
          this.options.navthumbtitleheight;
        ...
        if (
          ...
          styleCss +=
            ...
            "}";
          styleCss +=
            ".amazingslider-bullet-selected .amazingslider-nav-thumbnail-tite-" +
            this.id +
            ", .amazingslider-bullet-highlighted .amazingslider-nav-thumbnail-tite-" +
            this.id +
            " {" +
            this.options.navthumbtitlehovercss +
            "}";
      ...
      createBottomShadow: function () {
        ...
        $shadow.html(
          "<img alt='' src='" +
            ...
            "' style='display:block;position:relative;width:100%;height:auto;max-width:0%;' />"
        );
      },
      ...
      createArrows: function () {
        ...
        $leftArrow.click(function () {
          instance.container.trigger("amazingslider.arrow", [
            instance.curElem,
            -2,
          ]);
          instance.videoAutoplayMode = false;
        ...
        if (winW < this.options.navthumbsmallsize) {
          if (
            ...
            this.options.navwidth =
              (this.options.width -
                this.options.navspacing *
                  (this.options.navthumbsmallcolumn - 1)) /
              this.options.navthumbsmallcolumn;
            this.options.navheight =
          ...
          this.options.navthumbtitleheight =
            this.options.navthumbsmalltitleheight;
          this.options.navthumbtitlewidth =
            this.options.navthumbsmalltitlewidth;
          ...
          if (
            ...
            this.options.navwidth =
              (this.options.width -
                this.options.navspacing *
                  (this.options.navthumbmediumcolumn - 1)) /
              this.options.navthumbmediumcolumn;
            this.options.navheight =
              (this.options.navwidth * this.options.navoriginalheight) /
              this.options.navoriginalwidth;
          ...
          this.options.navthumbtitleheight =
            this.options.navthumbmediumtitleheight;
          this.options.navthumbtitlewidth =
            this.options.navthumbmediumtitlewidth;
        } else {
          if (
            this.options.navthumbresponsivemode == "samecolumn" &&
            this.options.navdirection == "horizontal"
            ...
            this.options.navwidth =
              (this.options.width -
                this.options.navspacing *
                  (this.options.navthumboriginalcolumn - 1)) /
      ...
      createNav: function () {
        ...
        if (this.options.navstyle != "none") {
          ...
          if (
            instance.options.navmultirows &&
            instance.options.navdirection == "horizontal" &&
            instance.options.navthumbresponsivemode == "samecolumn"
          ) {
            var $bullets = $(
            ...
            for (var i = 1; i < $bullets.length; i++)
              if ((i + 1) % instance.options.navthumbcolumn == 0)
                ...
                $bullets
                  .eq(i)
                  .css({ "margin-right": instance.options.navspacing + "px" });
          }
          if (instance.options.navthumbnavigationstyle == "auto")
            ...
            if (instance.options.navdirection == "vertical") {
              $carLeftArrow.css({
                top:
                  instance.options.navthumbnavigationstyle == "arrowoutside"
                    ? "-" +
        ...
        if (this.options.navshowbuttons) {
          ...
          if (this.options.navshowplaypause) {
            ...
            if (this.options.navarrowimage)
              $navPlay.css({
                "background-image":
                  "url('" + this.options.navplaypauseimage + "')",
                "background-repeat": "no-repeat",
                "background-position": "left top",
              });
            $navPlay.hover(
      ...
      resizeNavBullets: function () {
        ...
        $(".amazingslider-bullet-" + this.id, this.container).each(function () {
          ...
          $(this).css({
            width:
              String(
                instance.options.navwidth - instance.options.navborder * 2
              ) + "px",
            height:
              String(
                instance.options.navheight - instance.options.navborder * 2
              ) + "px",
          });
            ...
            if (
              ...
              $(".amazingslider-bullet-img-" + instance.id, this).css({
                ...
                "margin-top":
                  "-" +
                  Math.floor(
                    ((h0 / w0) * instance.options.navimagewidth) / 2 -
              ...
              $(".amazingslider-bullet-img-" + instance.id, this).css({
                ...
                "margin-left":
                  "-" +
                  Math.floor(
                    ((w0 / h0) * instance.options.navimageheight) / 2 -
      ...
      createNavBullet: function (index) {
        ...
        var h =
          this.options.navstyle == "thumbnails"
            ...
            : this.options.navheight;
        var b =
          this.options.navdirection == "horizontal" && this.options.navmultirows
            ? "margin-bottom:" + this.options.navrowspacing + "px;"
            : "";
        var $bullet = $(
              ...
              if (instance.options.navshowplayvideo) {
                ...
                if (
                  ...
                  (instance.elemArray[bulletIndex][ELEM_LINK] &&
                    ...
                    instance.elemArray[bulletIndex][ELEM_VIDEOTYPE] > 0)
                )
                  $previewPlay.show();
        ...
        if (this.options.navstyle == "bullets") {
          ...
          $(imgLoader).on("load", function () {
            ...
            if (instance.options.navthumbstyle != "textonly") {
              ...
              if (
                ...
                style =
                  "max-width:none;width:100%;height:auto;margin-top:-" +
                  Math.floor(
                    ((this.height / this.width) *
                      instance.options.navimagewidth) /
                      2 -
                ...
                style =
                  "max-width:none;width:auto;height:100%;margin-left:-" +
                  Math.floor(
                    ((this.width / this.height) *
              ...
              if (
                ...
                (instance.elemArray[index][ELEM_VIDEO].length > 0 ||
                  (instance.elemArray[index][ELEM_LINK] &&
                    ...
                    instance.elemArray[index][ELEM_VIDEOTYPE] > 0))
              )
                $bullet.append(
          ...
          $.fn["bulletNormal" + this.id] = function () {
            ...
            $(this)
              .removeClass("amazingslider-bullet-selected")
              .removeClass("amazingslider-bullet-highlighted");
          ...
          $.fn["bulletHighlight" + this.id] = function () {
            ...
            $(this)
              .removeClass("amazingslider-bullet-selected")
              .addClass("amazingslider-bullet-highlighted");
          };
          $.fn["bulletSelected" + this.id] = function () {
            $(this).css({ opacity: 1, filter: "alpha(opacity=100)" });
            if (instance.options.navborderhighlightcolor)
            ...
            $(this)
              .removeClass("amazingslider-bullet-highlighted")
              .addClass("amazingslider-bullet-selected");
            instance.adjustNav(this);
          };
        }
        return $bullet;
      ...
      adjustNav: function (bullet) {
        ...
        if (instance.options.navdirection == "horizontal") {
          ...
          if (
            ...
            if (
              pos.left < m ||
              pos.left + instance.options.navwidth > m + $navContainer.width()
            ) {
              var pl = -pos.left;
          ...
          if (
            ...
            if (
              pos.top < m ||
              pos.top + instance.options.navheight > m + $navContainer.height()
            ) {
              var pl = -pos.top;
      ...
      slideRun: function (index, playVideo, transEffect) {
        ...
        if (
          savedCur == this.curElem &&
          !(this.elemArray[this.curElem][ELEM_VIDEO].length > 0 && playVideo)
        )
          return;
        if (savedCur >= 0)
          this.container.removeClass(
            "amazingslider-activeslide-" + this.id + "-" + savedCur
          );
        this.container.addClass(
          "amazingslider-activeslide-" + this.id + "-" + this.curElem
        );
        if (this.isAnimating) {
          if (this.transitionTimeout) clearTimeout(this.transitionTimeout);
          $(".amazingslider-img-box-" + this.id, this.container).off(
            "transitionFinished"
          );
          var imageCodes =
          ...
          imageCodes +=
            "<img alt='" +
            this.elemArray[savedCur][ELEM_ALT] +
        ...
        if (
          elemTextEffect &&
          elemTextEffect.length > 0 &&
          "textformat" in this.options &&
          elemTextEffect in this.options["textformat"]
        )
          this.textoptions = $.ASUpdateObject(
            this.textoptions,
            this.options["textformat"][elemTextEffect]
          );
        else
      ...
      checkMK: function () {
        if (
          ...
          if (
            item.text().indexOf(this.options.watermarktext) < 0 ||
            mklink.length < 0
          ) {
            var itemtext =
            ...
            $box.amazingsliderTransition(
              ...
              $imgCur,
              {
                ...
                threedhorizontalwithzoom:
                  instance.options.threedhorizontalwithzoom,
              ...
              function () {
                instance.isAnimating = false;
                if (!instance.isPausedOnMouseover)
    ...
    this.each(function () {
      ...
      if (this.options.customtexteffect)
        try {
          this.options.customeffects = $.parseJSON(
            this.options.customtexteffect
          );
        } catch (err) {}
      if (
        $("#amazingslider_customtexteffect_" + this.options.sliderid).length > 0
      )
        try {
          this.options.customeffects = $.parseJSON(
            $("#amazingslider_customtexteffect_" + this.options.sliderid).text()
          );
        } catch (err) {}
      if (
        ...
        if (this.options.textformat in AMAZINGSLIDER_TEXT_EFFECT_FORMATS)
          this.options = $.extend(
            {},
            AMAZINGSLIDER_TEXT_EFFECT_FORMATS[this.options.textformat],
            this.options
          );
      if (this.options.textformat && this.options.customeffects)
        if (this.options.textformat in this.options.customeffects)
          this.options = $.extend(
            {},
            this.options.customeffects[this.options.textformat],
            this.options
          );
      if (
        $(this).data("skin") &&
      ...
      var defaultOptions = {
        ...
        lightboxtitlebottomcss:
          "color:#333; font-size:14px; font-family:Armata,sans-serif,Arial; overflow:hidden; text-align:left;",
        ...
        lightboxsocialpositionsmallscreen:
        ...
        wstyledefault: "text",
        wtextdefault:
          "65,109,97,122,105,110,103,32,83,108,105,100,101,114,32,70,114,101,101,32,86,101,114,115,105,111,110",
        wimagedefault: "",
        wpamcss:
          "position:absolute;top:6px;left:6px;visibility:visible !important;z-index:999999 !important;display:block !important;",
        wtextcssdefault:
      ...
      for (var key in this.options)
        if (key.substring(0, 17) == "customtransition_") {
          ...
          if (matches.length == 3)
            if (effects.indexOf(matches[1]) >= 0)
              this.options[matches[1]][matches[2]] = this.options[key];
        }
      ...
      if (
        ...
        this.options.showwatermark =
          window.location.href.indexOf(d0) >= 0 ? false : true;
      ...
      if (typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined") {
        ...
        if (this.options.customeffects)
          this.options.textformat = $.extend(
            {},
            this.options.textformat,
            this.options.customeffects
          );
      }
      var image_list = [
        "arrowimage",
        ...
        if (this.options[image_list[i]])
          if (
            ...
            this.options[image_list[i]] =
              this.options.skinsfolder + this.options[image_list[i]];
      var sliderid;
...
(function ($) {
  $.fn.amazingsliderTransition = function (
    ...
    if (
      (effect == "threed" ||
        effect == "threedwithzoom" ||
        effect == "threedtiles" ||
        effect == "threedhorizontal" ||
        effect == "threedhorizontalwithzoom" ||
        effect == "threedflip" ||
        effect == "threedflipwithzoom") &&
      !ASPlatforms.css33dTransformSupported()
    )
      effect = transition[effect].fallback;
    if (
      (effect == "flip" || effect == "flipwithzoom" || effect == "tiles") &&
      ASPlatforms.isIE6789()
    )
      effect = transition[effect].fallback;
  ...
  $.fn.kenburnsTransition = function (
    id,
    $prev,
    $next,
    options,
    ...
    if (ASPlatforms.isIE6789()) {
      ...
      if (effect == "zoomout") {
        ...
        $next.animate(
          { opacity: 1, width: scale + "%", height: scale + "%" },
          options.duration,
          options.easing
        );
      }
      ...
      var $canvas = $(
        '<canvas class="amazingslider-img-canvas-' +
          id +
          '" width="' +
          w +
          '" height="' +
  ...
  $.fn.threedTransition = function (
    ...
    var scaleDuration =
      options.scale == 1 ? 0 : options.scaleduration - scalePrepare;
    ...
    if (scaleDuration > 0) {
      ...
      setTimeout(function () {
        cubes.css(
          ASPlatforms.applyBrowserStyles({
            transform:
              "scale(" + options.scale + ") translateZ(-" + dist + "px" + ")",
          })
        );
      }, scalePrepare);
    }
  ...
  $.fn.threedFlipTransition = function (
    id,
    $prev,
    $next,
    options,
    ...
    for (i = 0; i < options.slicecount; i++) {
      ...
      $left.css(
        ASPlatforms.applyBrowserStyles({
          ...
          "backface-visibility": "hidden",
          transform:
            "rotateY(-90deg) translateZ(" + options.depth / 2 + "px" + ")",
        })
      );
      $right.css(
        ASPlatforms.applyBrowserStyles({
      ...
      $nextImgSlice.css(
        ASPlatforms.applyBrowserStyles({
          ...
          "backface-visibility": "hidden",
          transform:
            "rotateY(-180deg) translateZ(" + options.depth / 2 + "px" + ")",
        })
      );
      $curImgSlice.css(
        ASPlatforms.applyBrowserStyles({
  ...
  $.fn.threedtilesTransition = function (
    id,
    $prev,
    $next,
    options,
    ...
    for (i = 0; i < options.rowcount; i++)
      for (j = 0; j < options.columncount; j++) {
        ...
        var $nextImgBlock = $(
          "<div class='amazingslider-img-block-next amazingslider-img-block-" +
            id +
            " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>"
        );
        ...
        if (Math.abs(options.previmgmarginleft) > 0) {
          $curImg.css({
            "margin-left":
              options.columncount * options.previmgmarginleft + "%",
          });
          $curImg.css({
        ...
        var $curImgBlock = $(
          "<div class='amazingslider-img-block-current amazingslider-img-block-" +
            id +
            " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>"
        );
  ...
  $.fn.tilesTransition = function (
    ...
    $parent.append($cubeWrapper);
    $cubeWrapper.css(
      ASPlatforms.applyBrowserStyles({ "transform-style": "preserve-3d" })
    );
    $next.hide();
    for (i = 0; i < options.rowcount; i++)
      for (j = 0; j < options.columncount; j++) {
        ...
        $nextImgBlock.css(
          ASPlatforms.applyBrowserStyles({ transform: "rotateY(180deg)" })
        );
        $curImgBlock.css(
          ASPlatforms.applyBrowserStyles({
            "transform-style": "preserve-3d",
        ...
        $curImgBlock.css(
          ASPlatforms.applyBrowserStyles({ transform: "rotateY(0deg)" })
        );
      }
    var blocks = $(".amazingslider-img-cube-" + id, $parent);
    $parent.off("transitionFinished").on("transitionFinished", function () {
    ...
    blocks.each(function () {
      ...
      setTimeout(function () {
        block
          .find(".amazingslider-img-block-next")
          .css(
            ASPlatforms.applyBrowserStyles({
              "transition-timing-function": options.easing,
              "transition-duration": duration + "ms",
        ...
        block
          .find(".amazingslider-img-block-current")
          .css(
            ASPlatforms.applyBrowserStyles({
              "transition-timing-function": options.easing,
              "transition-duration": duration + "ms",
  ...
  $.fn.flipTransition = function (
    ...
    cubes.each(function () {
      ...
      setTimeout(function () {
        cube
          .find(".amazingslider-img-slice-next")
          .css(
            ASPlatforms.applyBrowserStyles({
              "transition-timing-function": options.easing,
              "transition-duration": duration + "ms",
        ...
        cube
          .find(".amazingslider-img-slice-current")
          .css(
            ASPlatforms.applyBrowserStyles({
              "transition-timing-function": options.easing,
              "transition-duration": duration + "ms",
